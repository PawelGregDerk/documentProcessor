...
@Service
public class FmeaWordGenerator extends AbstractWordGenerator {
        ...
        try (var inp = inpPath.getInputStream(); var doc = new XWPFDocument(inp)) {
            ...
            for (var oper : dto.opers()) {
                ...
                if (oper.funcs().isEmpty()) {
                    ...
                    fillTextCell(row.getCell(2), oper.extra());
                ...
                fillTextCell(table.getRow(startRow).getCell(2), oper.extra());
